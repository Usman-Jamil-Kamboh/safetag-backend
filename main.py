  ...
  <div style="background:#fff;border-radius:22px 22px 0 0;padding:28px 24px 36px;
    ...
    <form method="POST" action="/scan/{qr_id}/switch-to-basic" id="switch-plan-form">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;
        ...
        {chr(10).join('<button type="button" onclick="spp(' + chr(39) + d + chr(39) + ')" style="padding:14px;font-size:18px;font-weight:600;background:#f5f5f0;border:1.5px solid #e8e8e8;border-radius:11px;cursor:pointer">' + d + '</button>' for d in ['1','2','3','4','5','6','7','8','9','','0','\u232b'])}
      </div>
